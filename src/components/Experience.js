            ...
            <div className="container experience-wrapper">
                ...
                <div className="timeline-block timeline-block-left">
                    ...
                    <div className="timeline-content">
                        ...
                        <p>Developed the Recruitment HR website used as a job application and candidate's notification system as well as for posting employment advertisements, Maintained HR personnel management system and multi-browser processing.
                        </p>
                    </div>
                </div>
